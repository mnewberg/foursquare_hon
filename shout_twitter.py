...
def send_twitter_shout(t_handle,sender,f_name,venue_name,uid):
    ...
    options=[('@'+t_handle+' '+'Yo '+f_name+'! This is crazy but '+ sender+' just saw you check-in @ '+ venue_name +' & challenged you to a trivia game: '+ url),('@'+t_handle+' '+'Hey '+f_name+'! This is crazy but '+ sender +' just saw you check-in @ '+ venue_name +' & challenged you to trivia: '+ url),('@'+t_handle+' '+'Hey '+f_name+'! '+ sender+' is around the corner from your check-in @ '+ venue_name +' & challenged you to a game of trivia: '+ url)]
    try: 
